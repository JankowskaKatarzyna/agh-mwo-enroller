...
public class ParticipantRestControllerTest
{
    ...
    public void getParticipant() throws Exception
    {
        ...
        mvc.perform(get("/participants/testlogin").contentType(MediaType.APPLICATION_JSON))
                        ...
                        .andExpect(content()
                                        .string("{\"login\":\"testlogin\",\"password\":\"testpassword\"}"))
    ...
    {
        when(participantService.findByLogin("anotherUser"))
                        .thenThrow(new NoParticipantFoundException());

        mvc.perform(get("/participants/anotherUser").contentType(MediaType.APPLICATION_JSON))
